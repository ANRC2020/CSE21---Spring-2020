...
public class Lab21_Objects {
	public static void main(String[] args) {
		...
		dlist[6] = new Dummy(darr, iarr);
		dlist[7] = new Dummy(darr[0], iarr);
		dlist[8] = new Dummy(iarr, darr[0]);
		dlist[9] = new Dummy(dlist[0], darr[0]);

		dlist[10].display(dlist[0], dlist[1]);
		...
		dlist[6].display(darr, iarr);
		dlist[7].display(darr[0], iarr);
		dlist[8].display(iarr, darr[0]);
		dlist[9].display(dlist[0], darr[0]);
		dlist[10] = new Dummy(dlist[0], dlist[1]);
	}
}
